...
class AuthenticationTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        db.create_all()
        hashed_pass = sha256_crypt.hash(self.app.config['PASSWORD'])
    ...
    def test_login_logout(self):
        ...
        request = self._login(self.app.config['USERNAME'],
    ...
    def test_invalid_login(self):
        ...
        request = self._login(self.app.config['USERNAME'] + ' Y',
                             self.app.config['PASSWORD'] + ' Y')
